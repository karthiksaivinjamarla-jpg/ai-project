...
export function StaffDashboardPage() {
  ...
  const update = async (changes: { status?: EnquiryStatus; assignedTo?: string; resolution?: string }) => { if (!selected) return; const updated = await service.updateEnquiry(selected, changes); setSelected(updated); await refresh() }
