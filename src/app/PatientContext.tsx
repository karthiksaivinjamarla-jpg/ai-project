...
import { ResilientAIService } from '../services/ai'
import { BrowserEnquiryRepository } from '../services/data'

const service = new PatientEnquiryService(new BrowserEnquiryRepository(demoPatients, demoEnquiries), new ResilientAIService())
